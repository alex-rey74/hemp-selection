...
class WC_Vivawallet_ApplePay {
	...
	public function scripts() {
		...
		$creds = WC_Vivawallet_Credentials::get_credentials();

		if ( empty( $creds['token_front'] ) ) {
		...
		wp_register_style( 'vivawallet_styles_apple_pay', plugins_url( '/assets/css/vivawallet-styles-apple-pay.css', __FILE__ ), array(), WC_VIVAWALLET_VERSION );
		wp_enqueue_style( 'vivawallet_styles_apple_pay' );

		wp_register_script( 'woocommerce_vivawallet_apple_pay', plugins_url( '/assets/js/apple-pay-vivawallet.js', __FILE__ ), array( 'jquery' ), WC_VIVAWALLET_VERSION, true );
